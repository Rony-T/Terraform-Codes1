#--------------------------------------------------------------------
# SQL Database creation - Variables
#--------------------------------------------------------------------
...
variable "mssql_db_auto_pause_delay_in_minutes" {
...
variable "mssql_db_creation_source_database_id" {
...
variable "mssql_db_elastic_pool_id" {
...
variable "mssql_db_min_capacity" {
...
variable "mssql_db_restore_point_in_time" {
...
variable "mssql_db_read_replica_count" {
...
variable "mssql_db_tags" {
  description = "Tag Database details"
  type        = map(string)
  default     = {}
}
/*
...
variable "mssql_resourcegroup_name" {
  description = "Resource group where the sql server deploy"
  type        = string
}
variable "mssql_name" {
  description = "Resource group where the sql server deploy"
